...
report(%modrun%,'Production','PCap','Mass',country,f,a) = Pcap(f) + sum(aa$(ORD(aa) < ORD(a)), Pinv.l(aa,f))
                                                             - sum(aa$(ORD(aa) < ORD(a)),( sum(c$DomProd(f,c),kfs(f)*x.l(aa,f,c))+ sum(e$ExProd(f,e),kfs(f)*y.l(aa,f,e)))* mc_int_var(f));
report(%modrun%,'Production','Mort','Mass',country,f,a) = (sum(c$DomProd(f,c),kfs(f)*x.l(a,f,c))+ sum(e$ExProd(f,e),kfs(f)*y.l(a,f,e)))* mc_int_var(f);
report(%modrun%,'Production','MC at PCap','USD/t',country,f,a) = mc_int.l(a,f) + mc_slp_start(f) * report(%modrun%,'Production','PCap','Mass',country,f,a);
report(%modrun%,'Production','MC_int','USD/t',country,f,a) = mc_int.l(a,f);
report(%modrun%,'Production','MC at PLev','USD/t',country,f,a) = mc_int.l(a,f) + mc_slp_start(f) * (sum(c,kfs(f)*x.l(a,f,c)) + sum(e,kfs(f)*y.l(a,f,e))) ;


** Production Surplus **
report(%modrun%,'Production','PSur','mnUSD',country,f,a) = sum(c,p_c.l(a,c)*x.l(a,f,c)) + sum(e,p_e.l(a,e)*y.l(a,f,e)) - ( +( kfs(f)* mc_int.l(a,f)
...
report(%modrun%,'Production','PSur','mnUSD',country,f,'cum') = sum(a$(1 < ORD(a)),((1/(1 + r(f)))**(year(a)-2010)*report(%modrun%,'Production','PSur','mnUSD',country,f,a)
                                                           + (1/(1 + r(f)))**(year(a-1)-2010)*report(%modrun%,'Production','PSur','mnUSD',country,f,a-1))*plength/2 );
...
* make robust to zero quantities
report(%modrun%,'Price','PriceQ','USD/t',country,c,a)     = p_c.l(a,c)*( (sum(e,zz(e,c,a))+ sum(f,x.l(a,f,c)))/(sum(e,zz(e,c,a)*kes(e))+ sum(f,x.l(a,f,c)*kfs(f))));
...
report(%modrun%,'Consumption','CSur','mnUSD',country,sea,'cum')   = sum(a$(1 < ORD(a)),((1/(1 + r_c))**(year(a)-2010)*report(%modrun%,'Consumption','CSur','mnUSD',country,sea,a)
                                                           + (1/(1 + r_c))**(year(a-1)-2010)*report(%modrun%,'Consumption','CSur','mnUSD',country,sea,a-1) )*plength/2 );
report(%modrun%,'Consumption','CSur','mnUSD',country,land,'cum')  = sum(a$(1 < ORD(a)),((1/(1 + r_c))**(year(a)-2010)*report(%modrun%,'Consumption','CSur','mnUSD',country,land,a)
                                                           + (1/(1 + r_c))**(year(a-1)-2010)*report(%modrun%,'Consumption','CSur','mnUSD',country,land,a-1))*plength/2 );
...
report(%modrun%,'Exports','ESur','mnUSD',country,e,'cum') = sum(a$(1 < ORD(a)),((1/(1 + r_e(e)))**(year(a)-2010)*report(%modrun%,'Exports','ESur','mnUSD',country,e,a)
                                                        + (1/(1 + r_e(e)))**(year(a-1)-2010)*report(%modrun%,'Exports','ESur','mnUSD',country,e,a-1))*plength/2 );
...
report(%modrun%,'FOB','MC_init','USD/t',country,f,a)              =  mc_int.l(a,f)$(Prodcountry(f,country)) ;
report(%modrun%,'FOB','MC at PCap','USD/t',country,f,a)           =  (mc_int.l(a,f) + mc_slp_start(f) * report(%modrun%,'Production','PCap','Mass',country,f,a))$(Prodcountry(f,country));
...
report(%modrun%,'FOB','sum_shadow_prices','USD/t',e,f,a)          =  sum(country,(p_e.l(a,e)/kes(e)- (mc_int.l(a,f) + mc_slp_start(f) * (sum(c,x.l(a,f,c))+ sum(ee,y.l(a,f,ee)))*kfs(f)-trans_e(f,e,a)))$(Prodcountry(f,country) AND Expcountry(e,country)));
...
report(%modrun%,'Welfare','PSurD','mnUSD','All',country,a) =    sum(f$(ProdCountry(f,country)),
                                                                ...
                                                                +( kfs(f)* mc_int.l(a,f) + 0.5*kfs(f)**2 *mc_slp_start(f)*( sum(c,x.l(a,f,c))+ sum(e,y.l(a,f,e))))
